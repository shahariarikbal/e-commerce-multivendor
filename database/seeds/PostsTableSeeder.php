    ...
    public function run()
    {
        ...
        \DB::table('posts')->insert(array (
            ...
            array (
                ...
                'featured' => 0,
                'id' => 1,
                'image' => 'posts\\October2020\\3XU8Qw9Fzl7YM7N3xyIr.PNG',
                'meta_description' => 'This is the meta description',
                'meta_keywords' => 'keyword1, keyword2, keyword3',
                'pdf' => '[{"download_link":"posts\\\\November2020\\\\Y71P05MSBLnoZWMCDmGD.docx","original_name":"07_17101291.docx"}]',
                'post_cat_id' => 1,
                'seo_title' => NULL,
                'slug' => 'lorem-ipsum-post',
                'status' => 'PUBLISHED',
                'title' => 'Lorem Ipsum Post',
                'updated_at' => '2020-11-12 06:13:40',
            ),
            1 => 
            array (
                'author_id' => 3,
...
<p>And include a bunch of other stuff.</p>',
                ...
                'meta_keywords' => 'keyword1, keyword2, keyword3',
                'pdf' => '[{"download_link":"posts\\/November2020\\/IQOHObsRrhFrJ7rjM70T.pdf","original_name":"18221394_Layout-App-Resellersfy.pdf"}]',
                'post_cat_id' => 2,
                'seo_title' => NULL,
                'slug' => 'my-sample-post',
                'status' => 'PUBLISHED',
                'title' => 'My Sample Post',
                'updated_at' => '2020-11-12 06:13:54',
            ),
            2 => 
            array (
                'author_id' => 0,
...
<p>Interloper heave down list driver pressgang holystone scuppers tackle scallywag bilged on her anchor. Jack Tar interloper draught grapple mizzenmast hulk knave cable transom hogshead. Gaff pillage to go on account grog aft chase guns piracy yardarm knave clap of thunder.</p>',
            ...
            array (
                'author_id' => 3,
                'body' => '<p>ok</p>',
                'created_at' => '2020-11-16 18:25:26',
                'excerpt' => 'normal desc',
                'featured' => 0,
                'id' => 5,
                'image' => NULL,
                ...
                'meta_keywords' => NULL,
                'pdf' => '[{"download_link":"posts\\/November2020\\/Pj7FZUtA7cL7uUT6MZql.pdf","original_name":"376-A1015.pdf"}]',
                'post_cat_id' => 2,
                'seo_title' => NULL,
                'slug' => 'post-checker',
                'status' => 'PUBLISHED',
                'title' => 'post checker',
                'updated_at' => '2020-11-16 18:25:26',
            ),
        ));
