            ...
            <div class="row">
                <div class="col-2">
                    ...
                    <div class="list-group">
                        <a href="/inventory" class="list-group-item list-group-item-action active">Dashboard</a>
                        <a href=" {{url('/admin')}} " class="list-group-item list-group-item-action">Admin Page</a>
                    </div>
